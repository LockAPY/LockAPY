...
/*
LockAPY is Decentralized Finance with Auto-Compounding & Auto-Staking Protocol Providing Investors with Sustainable 
Fixed Annual Yield of 365%. LockAPY Protocol is powered by Positive Rebase Algorithm, which allowed token distribution 
to holders with 0.02084% every 30 Minutes which resulted in daily return of 1% everyday 

Telegram : https://t.me/LockAPY
Website : https://lockapy.com
*/
...
contract LockAPY is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 public rewardYield = 2084000; //rebase with 0.02084% Every 30 Minutes result in 1% Every day with 48x Rebase time perday
    uint256 public rewardYieldDenominator = 100000000; // Yielding Denonominators
    uint256 public maxSellTransactionAmount = 3650000 * 10 ** 18;

    uint256 public rebaseFrequency = 1800;
    uint256 public nextRebase = block.timestamp + 777600;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 365 * 10**6 * 10**DECIMALS;
    ...
    address public liquidityReceiver = 0x5a1905c3c9C8C656735F94114AdDDcad44976b90;
    address public treasuryReceiver = 0x04dE1f0d82870512f1B5AAbf90D6f31d0b4b686E;
    address public insuranceFundReceiver = 0xA5ec3F005B3a9F515c0cabc28a07502AecA7fdC0;
    ...
    uint256 public insuranceFundFee = 2;
    uint256 public sellFeeTreasuryAdded = 4;
    uint256 public sellFeeInsuranceAdded = 4;
    uint256 public totalBuyFee = liquidityFee.add(treasuryFee).add(insuranceFundFee);
    uint256 public totalSellFee = totalBuyFee.add(sellFeeTreasuryAdded).add(sellFeeInsuranceAdded);
    ...
    constructor() ERC20Detailed("LOCKAPY", "LOCKAPY", uint8(DECIMALS)) {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToRFV = contractTokenBalance.mul(insuranceFundFee.mul(2).add(sellFeeInsuranceAdded)).div(realTotalFee);
        ...
        if(amountToRFV > 0){
            _swapTokensForBusd(amountToRFV, insuranceFundReceiver);
        }
    ...
    function setFeeReceivers(address _liquidityReceiver, address _treasuryReceiver, address _InsuranceFundReceiver) external onlyOwner {
